...
$mysqli = new mysqli("db", "guanafarm", "guanafarm", "guanafarm");
...
if (!empty($products)) {
    foreach ($products as $product) {
        ...
        echo "<td class=\"u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell\"> <img src=\"$product->image\" style='max-width: 150px'> </td >";
        echo "</tr >";
    }
} else {
